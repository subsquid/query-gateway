...
pub async fn run_server(
    ...
    let app = Router::new()
        ...
        // TODO More convenient path would be `/datasets/:dataset/height`.
        // Maybe it's better to preserve old URLs, but create new ones in new format
        //
        // .route("/datasets/:dataset/state", post(get_dataset_state))
        // .route("/datasets/:dataset/height", post(get_height))
        ...
        .route("/network/:dataset/state", get(get_dataset_state))
